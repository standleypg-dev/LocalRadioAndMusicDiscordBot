...
using Song = Domain.Song;

namespace radio_discord_bot.Services;
using Microsoft.EntityFrameworkCore;

public class StatisticsService(DiscordBotContext context, IYoutubeService youtubeService): IStatisticsService
{
    // Log when a user plays a song
    public async Task LogSongPlayAsync(SocketUser socketUser, Models.Song playedSong)
    {
